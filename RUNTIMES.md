...
In diesem Dokument sind die Laufzeiten und Ausgaben des IR-Systems für die Testdaten zu finden.
...
Abfrage: `information AND retrieval`
...
Abfrage: `information AND NOT retrieval`
...
Abfrage: `(information OR data) AND analysis`
...
Abfrage: `information /10 retrieval`
...
Abfrage: `information /10 retrieval AND "library of congress"`
...
Abfrage: `reserch` K-Gramm Größe: 6
...
Abfrage: `reserch` K-Gramm Größe: 5
...
Abfrage: `reserch` K-Gramm Größe: 4
...
Abfrage: `reserch` K-Gramm Größe: 3
...
Abfrage: `reserch` K-Gramm Größe: 2
...
Abfrage: `analysi` K-Gramm Größe: 6
...
Abfrage: `analysi` K-Gramm Größe: 5
...
Abfrage: `analysi` K-Gramm Größe: 4
...
Abfrage: `analysi` K-Gramm Größe: 3
